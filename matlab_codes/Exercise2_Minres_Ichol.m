...
[~, ~, ~, ~, resvec] = minres(A, b, tol, maxit, L, L', x0);
...
title('MINRES Convergence with Incomplete Cholesky Preconditioning', ...
...
% Legend
legend({'MINRES with ICHOL'}, 'Location', 'southwest', 'FontSize', 12, 'Box', 'off');
...
exportgraphics(gcf, 'minres_ichol.png', 'Resolution', 300);
